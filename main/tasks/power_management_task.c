...
// Set the fan speed between 35% min and 100% max based on chip temperature as input.
// The fan speed increases from 35% to 100% proportionally to the temperature increase from 45 and THROTTLE_TEMP
