...
void ASIC_result_task(void *pvParameters)
{
    ...
    while (1)
    {
        ...
        ESP_LOGI(TAG, "Ver %08X, Nonce %08X diff %.1f of %ld.", asic_result->rolled_version, asic_result->nonce, nonce_diff, GLOBAL_STATE->ASIC_TASK_MODULE.active_jobs[job_id]->pool_diff);
