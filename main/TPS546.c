...
static float ulinear16_2_float(uint16_t value)
{
    ...
    smb_read_byte(TPS546_I2CADDR, PMBUS_VOUT_MODE, &voutmode);
...
int TPS546_init(void)
{
    ...
    smb_read_block(TPS546_I2CADDR, PMBUS_IC_DEVICE_ID, data, 6);
    ...
    smb_write_byte(TPS546_I2CADDR, PMBUS_ON_OFF_CONFIG, u8_value);
    ...
    ESP_LOGI(TAG, "-----------TIMING---------------------");
    smb_read_word(TPS546_I2CADDR, PMBUS_TON_DELAY, &u16_value);
    temp = slinear11_2_int(u16_value);
    ESP_LOGI(TAG, "TON_DELAY: %d", temp);
    smb_read_word(TPS546_I2CADDR, PMBUS_TON_RISE, &u16_value);
    temp = slinear11_2_int(u16_value);
    ESP_LOGI(TAG, "TON_RISE: %d", temp);
    smb_read_word(TPS546_I2CADDR, PMBUS_TON_MAX_FAULT_LIMIT, &u16_value);
    temp = slinear11_2_int(u16_value);
    ESP_LOGI(TAG, "TON_MAX_FAULT_LIMIT: %d", temp);
    smb_read_byte(TPS546_I2CADDR, PMBUS_TON_MAX_FAULT_RESPONSE, &u8_value);
    ESP_LOGI(TAG, "TON_MAX_FAULT_RESPONSE: %02x", u8_value);
    smb_read_word(TPS546_I2CADDR, PMBUS_TOFF_DELAY, &u16_value);
    temp = slinear11_2_int(u16_value);
    ESP_LOGI(TAG, "TOFF_DELAY: %d", temp);
    smb_read_word(TPS546_I2CADDR, PMBUS_TOFF_FALL, &u16_value);
    temp = slinear11_2_int(u16_value);
    ESP_LOGI(TAG, "TOFF_FALL: %d", temp);
    ESP_LOGI(TAG, "--------------------------------------");

    // Read the compensation config registers
    smb_read_block(TPS546_I2CADDR, PMBUS_COMPENSATION_CONFIG, comp_config, 5);
...
void TPS546_read_mfr_info(uint8_t *read_mfr_revision)
{
    ...
    smb_read_block(TPS546_I2CADDR, PMBUS_MFR_ID, read_mfr_id, 3);
    read_mfr_id[3] = 0x00;
    smb_read_block(TPS546_I2CADDR, PMBUS_MFR_MODEL, read_mfr_model, 3);
    read_mfr_model[3] = 0x00;
    smb_read_block(TPS546_I2CADDR, PMBUS_MFR_REVISION, read_mfr_revision, 3);
...
void TPS546_set_mfr_info(void)
{
	...
	smb_write_block(TPS546_I2CADDR, PMBUS_MFR_ID, MFR_ID, 3);
	smb_write_block(TPS546_I2CADDR, PMBUS_MFR_MODEL, MFR_MODEL, 3);
	smb_write_block(TPS546_I2CADDR, PMBUS_MFR_REVISION, MFR_REVISION, 3);
}
...
void TPS546_write_entire_config(void)
{
    ...
    smb_write_byte(TPS546_I2CADDR, PMBUS_ON_OFF_CONFIG, TPS546_INIT_ON_OFF_CONFIG);

    /* Switch frequency */
    ESP_LOGI(TAG, "Setting FREQUENCY");
    smb_write_word(TPS546_I2CADDR, PMBUS_FREQUENCY_SWITCH, int_2_slinear11(TPS546_INIT_FREQUENCY));

    /* vin voltage */
    ESP_LOGI(TAG, "Setting VIN");
    smb_write_word(TPS546_I2CADDR, PMBUS_VIN_ON, float_2_slinear11(TPS546_INIT_VIN_ON));
    smb_write_word(TPS546_I2CADDR, PMBUS_VIN_OFF, float_2_slinear11(TPS546_INIT_VIN_OFF));
    smb_write_word(TPS546_I2CADDR, PMBUS_VIN_UV_WARN_LIMIT, float_2_slinear11(TPS546_INIT_VIN_UV_WARN_LIMIT));
    smb_write_word(TPS546_I2CADDR, PMBUS_VIN_OV_FAULT_LIMIT, float_2_slinear11(TPS546_INIT_VIN_OV_FAULT_LIMIT));
    smb_write_byte(TPS546_I2CADDR, PMBUS_VIN_OV_FAULT_RESPONSE, TPS546_INIT_VIN_OV_FAULT_RESPONSE);

    /* vout voltage */
    ESP_LOGI(TAG, "Setting VOUT SCALE");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_SCALE_LOOP, float_2_slinear11(TPS546_INIT_SCALE_LOOP));
    ESP_LOGI(TAG, "VOUT_COMMAND");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_COMMAND, float_2_ulinear16(TPS546_INIT_VOUT_COMMAND));
    ESP_LOGI(TAG, "VOUT_MAX");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_MAX, float_2_ulinear16(TPS546_INIT_VOUT_MAX));
    ESP_LOGI(TAG, "VOUT_OV_FAULT_LIMIT");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_OV_FAULT_LIMIT, float_2_ulinear16(TPS546_INIT_VOUT_OV_FAULT_LIMIT));
    ESP_LOGI(TAG, "VOUT_OV_WARN_LIMIT");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_OV_WARN_LIMIT, float_2_ulinear16(TPS546_INIT_VOUT_OV_WARN_LIMIT));
    ESP_LOGI(TAG, "VOUT_MARGIN_HIGH");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_MARGIN_HIGH, float_2_ulinear16(TPS546_INIT_VOUT_MARGIN_HIGH));
    ESP_LOGI(TAG, "VOUT_MARGIN_LOW");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_MARGIN_LOW, float_2_ulinear16(TPS546_INIT_VOUT_MARGIN_LOW));
    ESP_LOGI(TAG, "VOUT_UV_WARN_LIMIT");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_UV_WARN_LIMIT, float_2_ulinear16(TPS546_INIT_VOUT_UV_WARN_LIMIT));
    ESP_LOGI(TAG, "VOUT_UV_FAULT_LIMIT");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_UV_FAULT_LIMIT, float_2_ulinear16(TPS546_INIT_VOUT_UV_FAULT_LIMIT));
    ESP_LOGI(TAG, "VOUT_MIN");
    smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_MIN, float_2_ulinear16(TPS546_INIT_VOUT_MIN));

    /* iout current */
    ESP_LOGI(TAG, "Setting IOUT");
    smb_write_word(TPS546_I2CADDR, PMBUS_IOUT_OC_WARN_LIMIT, float_2_slinear11(TPS546_INIT_IOUT_OC_WARN_LIMIT));
    smb_write_word(TPS546_I2CADDR, PMBUS_IOUT_OC_FAULT_LIMIT, float_2_slinear11(TPS546_INIT_IOUT_OC_FAULT_LIMIT));
    smb_write_byte(TPS546_I2CADDR, PMBUS_IOUT_OC_FAULT_RESPONSE, TPS546_INIT_IOUT_OC_FAULT_RESPONSE);

    /* temperature */
    ESP_LOGI(TAG, "Setting TEMPERATURE");
    ESP_LOGI(TAG, "OT_WARN_LIMIT");
    smb_write_word(TPS546_I2CADDR, PMBUS_OT_WARN_LIMIT, int_2_slinear11(TPS546_INIT_OT_WARN_LIMIT));
    ESP_LOGI(TAG, "OT_FAULT_LIMIT");
    smb_write_word(TPS546_I2CADDR, PMBUS_OT_FAULT_LIMIT, int_2_slinear11(TPS546_INIT_OT_FAULT_LIMIT));
    ESP_LOGI(TAG, "OT_FAULT_RESPONSE");
    smb_write_byte(TPS546_I2CADDR, PMBUS_OT_FAULT_RESPONSE, TPS546_INIT_OT_FAULT_RESPONSE);

    /* timing */
    ESP_LOGI(TAG, "Setting TIMING");
    ESP_LOGI(TAG, "TON_DELAY");
    smb_write_word(TPS546_I2CADDR, PMBUS_TON_DELAY, int_2_slinear11(TPS546_INIT_TON_DELAY));
    ESP_LOGI(TAG, "TON_RISE");
    smb_write_word(TPS546_I2CADDR, PMBUS_TON_RISE, int_2_slinear11(TPS546_INIT_TON_RISE));
    ESP_LOGI(TAG, "TON_MAX_FAULT_LIMIT");
    smb_write_word(TPS546_I2CADDR, PMBUS_TON_MAX_FAULT_LIMIT, int_2_slinear11(TPS546_INIT_TON_MAX_FAULT_LIMIT));
    smb_write_byte(TPS546_I2CADDR, PMBUS_TON_MAX_FAULT_RESPONSE, TPS546_INIT_TON_MAX_FAULT_RESPONSE);
    smb_write_word(TPS546_I2CADDR, PMBUS_TOFF_DELAY, int_2_slinear11(TPS546_INIT_TOFF_DELAY));
    smb_write_word(TPS546_I2CADDR, PMBUS_TOFF_FALL, int_2_slinear11(TPS546_INIT_TOFF_FALL));
    ...
    smb_write_word(TPS546_I2CADDR, PMBUS_PIN_DETECT_OVERRIDE, INIT_PIN_DETECT_OVERRIDE);

    /* TODO write new MFR_REVISION number to reflect these parameters */
    ESP_LOGI(TAG, "Writing MFR ID");
    smb_write_block(TPS546_I2CADDR, PMBUS_MFR_ID, MFR_ID, 3);
    ESP_LOGI(TAG, "Writing MFR MODEL");
    smb_write_block(TPS546_I2CADDR, PMBUS_MFR_ID, MFR_MODEL, 3);
    ESP_LOGI(TAG, "Writing MFR REVISION");
    smb_write_block(TPS546_I2CADDR, PMBUS_MFR_ID, MFR_REVISION, 3);

    /* store configuration in NVM */
    ESP_LOGI(TAG, "---Saving new config---");
    smb_write_byte(TPS546_I2CADDR, PMBUS_STORE_USER_ALL, 0x98);
...
int TPS546_get_frequency(void)
{
    ...
    smb_read_word(TPS546_I2CADDR, PMBUS_FREQUENCY_SWITCH, &value);
...
void TPS546_set_frequency(int newfreq)
{
    ...
    smb_write_word(TPS546_I2CADDR, PMBUS_FREQUENCY_SWITCH, value);
...
int TPS546_get_temperature(void)
{
    ...
    smb_read_word(TPS546_I2CADDR, PMBUS_READ_TEMPERATURE_1, &value);
...
float TPS546_get_vin(void)
{
    ...
    smb_read_word(TPS546_I2CADDR, PMBUS_READ_VIN, &u16_value);
...
float TPS546_get_iout(void)
{
    ...
    smb_read_word(TPS546_I2CADDR, PMBUS_READ_IOUT, &u16_value);
...
float TPS546_get_vout(void)
{
    ...
    /* Get voltage output (ULINEAR16) */
    smb_read_word(TPS546_I2CADDR, PMBUS_READ_VOUT, &u16_value);
...
void TPS546_set_vout(float volts)
{
    ...
    if (volts == 0) {
        /* turn off output */
        smb_write_byte(TPS546_I2CADDR, PMBUS_OPERATION, OPERATION_OFF);
    } else {
        ...
        if ((volts < TPS546_INIT_VOUT_MIN) || (volts > TPS546_INIT_VOUT_MAX)) {
            ...
            smb_write_word(TPS546_I2CADDR, PMBUS_VOUT_COMMAND, value);
            ESP_LOGI(TAG, "Vout changed to %1.2f V", volts);

            /* turn on output */
           smb_write_byte(TPS546_I2CADDR, PMBUS_OPERATION, OPERATION_ON);
        }
    }
}
...
void TPS546_show_voltage_settings(void)
{
    ...
    /* VIN_ON SLINEAR11 */
    smb_read_word(TPS546_I2CADDR, PMBUS_VIN_ON, &u16_value);
    f_value = slinear11_2_float(u16_value);
    ESP_LOGI(TAG, "VIN ON set to: %f", f_value);

    /* VIN_OFF SLINEAR11 */
    smb_read_word(TPS546_I2CADDR, PMBUS_VIN_OFF, &u16_value);
    f_value = slinear11_2_float(u16_value);
    ESP_LOGI(TAG, "VIN OFF set to: %f", f_value);

    /* VOUT_MAX */
    smb_read_word(TPS546_I2CADDR, PMBUS_VOUT_MAX, &u16_value);
    f_value = ulinear16_2_float(u16_value);
    ESP_LOGI(TAG, "Vout Max set to: %f V", f_value);

    /* VOUT_OV_FAULT_LIMIT */
    smb_read_word(TPS546_I2CADDR, PMBUS_VOUT_OV_FAULT_LIMIT, &u16_value);
    f_value = ulinear16_2_float(u16_value);
    ESP_LOGI(TAG, "Vout OV Fault Limit: %f V", f_value);

    /* VOUT_OV_WARN_LIMIT */
    smb_read_word(TPS546_I2CADDR, PMBUS_VOUT_OV_WARN_LIMIT, &u16_value);
    f_value = ulinear16_2_float(u16_value);
    ESP_LOGI(TAG, "Vout OV Warn Limit: %f V", f_value);

    /* VOUT_MARGIN_HIGH */
    smb_read_word(TPS546_I2CADDR, PMBUS_VOUT_MARGIN_HIGH, &u16_value);
    f_value = ulinear16_2_float(u16_value);
    ESP_LOGI(TAG, "Vout Margin HIGH: %f V", f_value);

    /* --- VOUT_COMMAND --- */
    smb_read_word(TPS546_I2CADDR, PMBUS_VOUT_COMMAND, &u16_value);
    f_value = ulinear16_2_float(u16_value);
    ESP_LOGI(TAG, "Vout set to: %f V", f_value);

    /* VOUT_MARGIN_LOW */
    smb_read_word(TPS546_I2CADDR, PMBUS_VOUT_MARGIN_LOW, &u16_value);
    f_value = ulinear16_2_float(u16_value);
    ESP_LOGI(TAG, "Vout Margin LOW: %f V", f_value);

    /* VOUT_UV_WARN_LIMIT */
    smb_read_word(TPS546_I2CADDR, PMBUS_VOUT_UV_WARN_LIMIT, &u16_value);
    f_value = ulinear16_2_float(u16_value);
    ESP_LOGI(TAG, "Vout UV Warn Limit: %f V", f_value);

    /* VOUT_UV_FAULT_LIMIT */
    smb_read_word(TPS546_I2CADDR, PMBUS_VOUT_UV_FAULT_LIMIT, &u16_value);
    f_value = ulinear16_2_float(u16_value);
    ESP_LOGI(TAG, "Vout UV Fault Limit: %f V", f_value);

    /* VOUT_MIN */
    smb_read_word(TPS546_I2CADDR, PMBUS_VOUT_MIN, &u16_value);
    f_value = ulinear16_2_float(u16_value);
